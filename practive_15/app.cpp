...
void App::titleDoubleClick(QMouseEvent* event)
{
  Q_UNUSED(event)
...
void App::axisLabelDoubleClick(QCPAxis *axis, QCPAxis::SelectablePart part)
{
  // Set an axis label by double clicking on it
    //通过双击设置一个轴标签
  if (part == QCPAxis::spAxisLabel) // only react when the actual axis label is clicked, not tick label or axis backbone    // 只在实际的轴标签被点击时做出反应，而不是打勾标签或轴骨干
  {
      qDebug() << "修改轴标签";
    bool ok;
...
void App::graphClicked(QCPAbstractPlottable *plottable, int dataIndex)
{
